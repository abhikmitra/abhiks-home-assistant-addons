...
**1.1.5 — durable exit latch:** Durable exit latch writes window+sessionStorage before PORTAL_EXIT, watcher checks immediately/keepalive, stale latch clears fail-closed before Hermes mic release, console remains non-reentrant fast path, one exit returns to Hermes.
